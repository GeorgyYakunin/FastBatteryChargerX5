...
public class ActivityMain extends AppCompatActivity implements View.OnClickListener, NativeAdsManager.Listener {
    ...
    CardView CardViewBatteryArc, CardViewTools, batteryDetail;
    ...
    private void setupdialog() {
        ...
        ratenoe_dialog = new AlertDialog.Builder(ActivityMain.this);
        ...
        writesetting_dialog = new AlertDialog.Builder(ActivityMain.this);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.batteryDetail:
                ...
                i = new Intent(getApplicationContext(), ActivityBatteryDetails.class);
                startActivity(i);
    ...
    public void onAdsLoaded() {
        ...
        scrollView = new NativeAdScrollView(ActivityMain.this, manager,
