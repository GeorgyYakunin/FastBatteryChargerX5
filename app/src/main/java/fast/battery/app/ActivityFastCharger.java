...
public class ActivityFastCharger extends AppCompatActivity implements View.OnClickListener, NativeAdsManager.Listener {
    ...
    public void onAdsLoaded() {
        ...
        scrollView = new NativeAdScrollView(ActivityFastCharger.this, manager, NativeAdView.Type.HEIGHT_300);
        ((LinearLayout) findViewById(R.id.NativeAdContainer)).setVisibility(View.VISIBLE);
