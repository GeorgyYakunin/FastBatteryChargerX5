...
public class ActivityBatteryDetails extends AppCompatActivity {
    ...
    public BroadcastReceiver batteryInfoReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            listAdepter = new ListAdepter(ActivityBatteryDetails.this, detail_name, detail_value, detailImage);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_bat_details);
